...
namespace Faregosoft.NewApi.Migrations
{
    ...
    [Migration("20210508134201_Providerstable2")]
    partial class Providerstable2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Faregosoft.NewApi.Data.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Faregosoft.NewApi.Data.Entities.Providers", b =>
                {
                    ...
                    b.Property<int>("PaymentCodition")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Faregosoft.NewApi.Data.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
